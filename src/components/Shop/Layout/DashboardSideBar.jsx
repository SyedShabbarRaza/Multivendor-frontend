...
function DashboardSideBar  ({ active,setActive }) {
  return (
    <div className="p-4 w-full h-[90vh] bg-white shadow-sm overflow-y-scroll sticky top-0 left-0 z-10">
      {/* single item */}
      <div className="w-full flex items-center p-4" onClick={()=> setActive(1)}>
